...
@app.route("/victor/")
def victor():
    return render_template("/victor/home.html", url=os.getenv("URL"))

@app.route("/victor/hobbies")
@app.route("/victor/hobbies/")
def victor_hobbies():
    return render_template("/victor/hobbies.html", url=os.getenv("URL"))


@app.route("/talike")
@app.route("/talike/")
def talike():
    return render_template("/talike/home.html", url=os.getenv("URL"))

@app.route("/talike/hobbies")
@app.route("/talike/hobbies/")
def talike_hobbies():
    return render_template("/talike/hobbies.html", url=os.getenv("URL"))
